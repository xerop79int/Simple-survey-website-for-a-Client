...
function InterviewQuestion10() {
  ...
  const videoFunction = async (blob) => {
    ...
    data.append('questionTitle', 'Tell me about your how your previous work experience can be used in this job.');
    ...
    <div>
      ...
      <div class="contentbody">
        ...
        <div class="right" style={{ margin: "-80px 10%" }}>
          <p style={{ color: "#ea5e11" }}>QUESTION 10</p><br />
          <p>Tell me about your how your previous work experience can be used in this job.</p>
...
export default InterviewQuestion10;