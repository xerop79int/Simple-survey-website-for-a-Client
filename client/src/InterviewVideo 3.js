...
function InterviewQuestion3() {
  const videoFunction = async (blob) => {
    ...
    data.append('questionTitle', 'Are you willing to work extra shifts or pick up extra shifts if they are offered?');
    ...
    <div>
      ...
      <div class="contentbody">
        ...
        <div class="right" style={{ margin: "-80px 10%" }}>
          <p style={{ color: "#ea5e11" }}>QUESTION 3</p><br />
          <p>Are you willing to work extra shifts or pick up extra shifts if they are offered?</p>
...
export default InterviewQuestion3;