...
function InterviewQuestion12() {
  ...
  const videoFunction = async (blob) => {
    ...
    data.append('questionTitle', 'How would you approach resolving a customer issue?');
    ...
    <div>
      ...
      <div class="contentbody">
        ...
        <div class="right" style={{ margin: "-80px 10%" }}>
          <p style={{ color: "#ea5e11" }}>QUESTION 12</p><br />
          <p>How would you approach resolving a customer issue?</p>
...
export default InterviewQuestion12;