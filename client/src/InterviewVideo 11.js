...
function InterviewQuestion11() {
  ...
  const videoFunction = async (blob) => {
    ...
    data.append('questionTitle', 'Describe your communication style – chatty or formal? Friendly or professional?');
    ...
    <div>
      ...
      <div class="contentbody">
        ...
        <div class="right" style={{ margin: "-80px 10%" }}>
          <p style={{ color: "#ea5e11" }}>QUESTION 11</p><br />
          <p>Describe your communication style – chatty or formal? Friendly or professional?</p>
...
export default InterviewQuestion11;