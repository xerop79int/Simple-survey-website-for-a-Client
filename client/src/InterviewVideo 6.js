...
function InterviewQuestion6() {
  const videoFunction = async (blob) => {
    ...
    data.append('questionTitle', 'What customer service experience do you have that you would like to share?');
    ...
    <div>
      ...
      <div class="contentbody">
        ...
        <div class="right" style={{ margin: "-80px 10%" }}>
          <p style={{ color: "#ea5e11" }}>QUESTION 6</p><br />
          <p>What customer service experience do you have that you would like to share?</p>
...
export default InterviewQuestion6;